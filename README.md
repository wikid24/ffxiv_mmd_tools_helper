...
What this tool will NOT do is allow you to import these motions back into the FFXIV game as it is a full conversion to an MMD Model structure (which is not compatible with FFXIV).
