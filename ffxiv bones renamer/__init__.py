bl_info = {
	"name": "ffxiv bones renamer",
	"author": "Hogarth-MMD, UuuNyaa, wikid24",
	"version": (2, 5),
	"blender": (2, 80, 0),
	"location": "View3D > Tool Shelf > ffxiv bones renamer",
...
class MMDToolsHelperPanel(bpy.types.Panel):
	"""Creates the FFXIV Bones Renamer Panel in a VIEW_3D TOOLS tab"""
	bl_label = "FFXIV Bones Renamer"
	bl_idname = "OBJECT_PT_ffxiv_bones_renamer"
	bl_space_type = "VIEW_3D"
	bl_region_type = "TOOLS" if bpy.app.version < (2,80,0) else "UI"
	bl_category = "ffxiv_bones_renamer"
