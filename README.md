...
> Update: 2024-04-19 - Development is on hold until Dawntrail comes out (I need to rewrite the entire plugin to support it). Also, still not compatible with [Blender V4.0](https://github.com/wikid24/ffxiv_mmd_tools_helper/issues/5) yet
