...
If you want to do that, please use XAT Tools and follow this [guide](https://docs.google.com/document/d/1siUjAAJjUk7-Nlq11wE-Sldr8UyCeu7SkFJzUsxZpTU/edit). If you want to port animation _into_ FFXIV, FFXIV models created with this addon must be treates as your source 'MMD' model, NOT your destination/target FFXIV model.
