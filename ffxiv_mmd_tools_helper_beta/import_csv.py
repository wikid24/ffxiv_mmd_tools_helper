...
def use_csv_shape_keys_dictionary(ffxiv_race):
	...
	path = "D:\\MMD\\ffxiv_mmd_tools_helper_beta\\ffxiv_mmd_tools_helper_beta\\"
	

	#shape_keys_dictionary = (__file__ + "shape_keys_" + ffxiv_race +".csv").replace("import_csv.py" , "")
	shape_keys_dictionary = (path + "shape_keys_" + ffxiv_race +".csv").replace("import_csv.py" , "")
	
	print (shape_keys_dictionary)
