...
def main(context):
	...
	bpy.context.object.pose.bones[KNEE_LEFT].constraints["Limit Rotation"].min_x = 0
	...
	bpy.context.object.pose.bones[KNEE_RIGHT].constraints["Limit Rotation"].min_x = 0
	...
	if 'j_asi_c_l' in [b.name for b in bpy.context.object.pose.bones]:
		...
		bpy.context.object.pose.bones['j_asi_c_l'].constraints["Limit Rotation"].min_x = 0
		bpy.context.object.pose.bones['j_asi_c_l'].constraints["Limit Rotation"].max_x = 0
		...
		bpy.context.object.pose.bones['j_asi_c_l'].constraints["Limit Rotation"].min_z = math.pi/360 #radians = 0.5 degrees #bugfix that it is exporting x axis to z axis in pmxe
		bpy.context.object.pose.bones['j_asi_c_l'].constraints["Limit Rotation"].max_z = math.pi #radians = 180 degrees #bugfix that it is exporting x axis to z axis in pmxe
	...
	if 'j_asi_c_r' in [b.name for b in bpy.context.object.pose.bones]:
		...
		bpy.context.object.pose.bones['j_asi_c_r'].constraints["Limit Rotation"].min_x = 0
		bpy.context.object.pose.bones['j_asi_c_r'].constraints["Limit Rotation"].max_x = 0
		...
		bpy.context.object.pose.bones['j_asi_c_r'].constraints["Limit Rotation"].min_z = math.pi/360 #radians = 0.5 degrees #bugfix that it is exporting x axis to z axis in pmxe
		bpy.context.object.pose.bones['j_asi_c_r'].constraints["Limit Rotation"].max_z = math.pi #radians = 180 degrees #bugfix that it is exporting x axis to z axis in pmxe
